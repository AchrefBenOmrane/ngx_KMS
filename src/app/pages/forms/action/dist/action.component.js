...
var ActionComponent = /** @class */ (function () {
    ...
    ActionComponent.prototype.updateList = function (id, property, event) {
        var editField = event.target.textContent;
        this.personList[id][property] = editField;
    };
    ActionComponent.prototype.remove = function (id) {
        this.awaitingPersonList.push(this.personList[id]);
        this.personList.splice(id, 1);
    };
    ActionComponent.prototype.add = function () {
    ...
    ActionComponent.prototype.changeValue = function (id, property, event) {
